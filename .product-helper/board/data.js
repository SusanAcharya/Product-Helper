window.__PH__ = {
  ...
  "cards": [
    ...
    },
    {
      "id": "ph-002",
      "title": "TaskTrack",
      "description": "The plan opens in the browser. Bookmark it. Run npx product-helper open anytime.",
      "status": "review",
      "labels": [
        "now",
        "feature"
    ...
    },
    {
      ...
      "description": "npx product-helper, or init with a GitHub URL, sets everything up and opens TaskTrack.",
      "status": "review",
      "labels": [
        "now",
        "docs",
    ...
    {
      "id": "ph-008",
      "title": "Visible TaskTrack",
      "description": "Setup opens the plan. TASKTRACK.md stays in git. The agent writes; people only read.",
      "status": "review",
      "labels": [
        "now",
        "feature"
  ...
  "milestones": [
    ...
    },
    {
      ...
      "horizon": "next",
      "status": "planned",
      "summary": "Human accepts Check cards for 1.2.0."
    },
    {
      "id": "later",
      "title": "Grow later",
